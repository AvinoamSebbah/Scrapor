from remotes import KaggleUploader, KafkaDbUploader, MongoDbUploader, DummyDocumentDbUploader, PostgresUploader, DummyFileStorage
...
def output_short_term_destination_from_env(output_destination):
    ...
    elif output_destination in {"postgres", "postgresql"}:
...
if __name__ == "__main__":
    ...
    publisher = SupermarketDataPublisher(
        ...
        ) if os.environ.get("KAGGLE_DATASET_REMOTE_NAME") else DummyFileStorage(
