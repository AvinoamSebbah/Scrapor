...
# from discord_logging.handler import DiscordHandler  # Moved inside conditional import
    ...
    if not logger.handlers:
        ...
        if discord_webhook_url:
            try:
                ...
                logger.warning("discord_logging module not found. Discord logging disabled.")
