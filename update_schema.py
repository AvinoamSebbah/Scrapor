        ...
        BEGIN
          ...
          scored_raw AS (
            ...
            WHERE pp.price IS NOT NULL
              ...
              AND p.item_name !~* '(^|[^א-ת])ווג([^א-ת]|$)'
              AND p.item_name NOT ILIKE '%פרלמנט%'
              AND p.item_name NOT ILIKE '%קנט%'
              AND p.item_name NOT ILIKE '%מלבורו%'
              AND p.item_name NOT ILIKE '%וינסטון%'
              AND p.item_name NOT ILIKE '%פאל מאל%'
              AND p.item_name NOT ILIKE '%קופסה אירופה%'
              AND p.item_name NOT ILIKE '%מונלייט%'
              AND p.item_name NOT ILIKE '%ג''ק דניאלס%'
              AND p.item_name NOT ILIKE '%ג׳ק דניאלס%'
              AND p.item_name NOT ILIKE '%סיגריה%'
              AND p.item_name NOT ILIKE '%סיגריות%'
              AND p.item_name NOT ILIKE '%סיגר%'
              AND p.item_name NOT ILIKE '%טבק%'
              AND p.item_name NOT ILIKE '%ניקוטין%'
