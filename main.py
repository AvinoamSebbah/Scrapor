from remotes import KaggleUploader, KafkaDbUploader, MongoDbUploader, DummyDocumentDbUploader, SupabaseUploader, DummyFileStorage
...
def output_short_term_destination_from_env(output_destination):
    ...
    elif output_destination in {"supabase", "postgres", "postgresql"}:
